...
const Adminsidebar = () => {
    return (
        <Box className='sidebar' backgroundColor={"#2d2d2d"} >
            <Flex className='adminsidebar'  >

                <Link to={"/admin"}>
                    <Flex className='three' justifyContent={"space-evenly"} padding={"6%"}   >
                ...
                <Link to="/admincustomers">
                    <Flex className='three' justifyContent={"space-evenly"} padding={"4%"} >
                        <Box className='iconcont' ><FiUsers className='icons' color='white' size={25} /></Box>
                        <Box className='labelcont' id='usercontainer'  ><Text className='labels' color='white' >Users</Text></Box>
                    </Flex>
                </Link>

                
                    <Accordion className='sidebarchild1' border={"0px solid #2d2d2d "} defaultIndex={[1]} allowMultiple>
                        <AccordionItem padding={"3%"}>
                            <h2>
                                <AccordionButton className='accordionbutton' color={"white"}>
                    ...
                    <Accordion className='sidebarchild2' border={"0px solid #2d2d2d "} defaultIndex={[1]} allowMultiple >
                        <AccordionItem padding={"3%"}>
                            <h2>
