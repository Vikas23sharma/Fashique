...
const Admindashboard = () => {
    return (
        ...
        <Box padding={"2%"}>
            ...
            <SimpleGrid marginTop={"4%"} columns={4} spacing={16}>
                <Box  textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px"  >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Total Sales</Text>
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>$566,788</Text>
                    <Text>This Month</Text>
                    <Text>View Report</Text>
                </Box>
                <Box textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Total Expenditure</Text>
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>$66,744</Text>
                    <Text>This Month</Text>
                    <Text>View Report</Text>
                </Box>
                <Box textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Net Profit</Text>
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>$500,448</Text>
                    <Text>This Month</Text>
                    <Text>View Report</Text>
                </Box>
                <Box textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Average Order Value</Text>
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>$1,788</Text>
                    <Text>This Month</Text>
                    <Text>View Report</Text>
                </Box>
                <Box textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Customer Acquisition</Text>
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>12%</Text>
                    <Text>This Month</Text>
                    <Text>View Report</Text>
                </Box>
                <Box textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Return Rate</Text>
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>3%</Text>
                    <Text>This Month</Text>
                    <Text>View Report</Text>
                </Box>
                <Box textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Growth Rate</Text>
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>22%</Text>
                    <Text>This Month</Text>
                    <Text>View Report</Text>
                </Box>
                <Box textAlign={"center"} padding={"3%"} boxShadow="rgba(50, 50, 93, 0.25) 0px 6px 12px -2px, rgba(0, 0, 0, 0.3) 0px 3px 7px -3px" >
                    <Text color={"#2d2d2d"} fontWeight={"medium"} fontSize={"3xl"}>Tax</Text>
