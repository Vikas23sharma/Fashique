...
return (
    ...
    <a href="#">
    <p>NEW IN</p>
    <img src="https://images.asos-media.com/navigation/ww_new+in_top+level_us_1m_126638577?&amp;$n_320w$&quot" alt="" />
    </a>
    </div>
    <div>
    <a href="#">
    ...
    <div style={{display:'flex',justifyContent:'space-evenly',margin:'1cm 0'}}>
        <p>Sign In </p>
        <p>|</p>
        <p>Join</p>
    </div>
